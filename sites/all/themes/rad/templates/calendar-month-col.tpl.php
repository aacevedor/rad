...
?>
<td <?php print $id?>class="<?php print $item['class'] ?><?php print ' num-event-'.substr_count($item['entry'], '<img') ?>" colspan="<?php print $item['colspan'] ?>" rowspan="<?php print $item['rowspan'] ?>"<?php print $date . $headers . $day; ?>>
  <div class="inner">
    <div class="day-rad">
	<?php print trim($item['day_of_month']) ?>
    </div>	
